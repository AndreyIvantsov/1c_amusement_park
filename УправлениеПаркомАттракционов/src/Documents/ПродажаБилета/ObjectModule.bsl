...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	ВидАттракциона = СвойстваНоменклатуры(Номенклатура);
	...
	Движение.ВидАттракциона = ВидАттракциона.ВидАттракциона;
	Движение.КоличествоПосещений = ВидАттракциона.КоличествоПосещений;
...
Функция СуммаПокупокКлиента()
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	ПродажиОбороты.СуммаДокументаОборот
	|ИЗ
	...
	Пока Выборка.Следующий() Цикл
		Возврат Выборка.СуммаДокументаОборот;
	КонецЦикла;
...
Функция ДоляНакапливаемыхБаллов(СуммаПокупокКлиента)
	...
	|		ПО ШкалаБонуснойПрограммыДиапазоны.Ссылка = АктуальнаяШкалаБонуснойПрограммыСрезПоследних.Шкала
	|ГДЕ
